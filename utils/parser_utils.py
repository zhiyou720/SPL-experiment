class ParserClass(object):
    def __init__(self, parser):
        ...
        parser.add_argument('--SPL',nargs="?", type=str, default= "None",help="the type of SPL")
        parser.add_argument('--pace_parameter', nargs="?", type=float, default=1.3, help="Pace parameter")
    ...
    def get_argument_variables(self):
        ...
        SPL = self.args.SPL
        pace_param = self.args.pace_parameter

        return batch_size, seed, epochs, logs_path, continue_from_epoch, tensorboard_enable, batch_norm, \
               strided_dim_reduction, experiment_prefix, dropout_rate, SPL, pace_param
