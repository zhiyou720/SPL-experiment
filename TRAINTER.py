...
strided_dim_reduction, experiment_prefix, dropout_rate_value, SPL, pace_param = parser_extractor.get_argument_variables()
# returns a list of objects that contain
# our parsed input

experiment_name = "experiment_{}_batch_size_{}_bn_{}_mp_{}_{}_{}".format(experiment_prefix,
                                                                   batch_size, batch_norm,
                                                                   strided_dim_reduction,SPL,pace_param)
...
classifier_network = ClassifierNetworkGraph(input_x=data_inputs, target_placeholder=data_targets,
                                            ...
                                            use_batch_normalization=batch_norm,SPL=SPL,pace_param =pace_param)  # initialize our computational graph
