...
class LeakyReluLayer(Layer):
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        gradients[inputs>0] = 1
        gradients[inputs<=0] = sigma
        return gradients * grads_wrt_outputs
...
class ELULayer(Layer):
    ...
    def fprop(self, inputs):
        ...
        """
        sigma = 1
        outputs = sigma * inputs #remove and replace with your code
        outputs[inputs<=0] = sigma *(np.exp(inputs[inputs<=0]) - 1)
        return outputs
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        """
        sigma = 1
        gradients = sigma * inputs #remove and replace with your code
        gradients[inputs>0] = 1
        gradients[inputs<=0] = sigma * np.exp(inputs[inputs<=0])
        return gradients * grads_wrt_outputs
...
class SELULayer(Layer):
    ...
    def fprop(self, inputs):
        ...
        Sigma = 1.6733
        Lambda = 1.0507
        outputs = Lambda * inputs #remove and replace with your code
        outputs[inputs<=0] = Lambda * Sigma * (np.exp(inputs[inputs<=0]) - 1)
        return outputs
    ...
    def bprop(self, inputs, outputs, grads_wrt_outputs):
        ...
        Lambda = 1.0507
        gradients = inputs #remove and replace with your code
        gradients[inputs>0] = Lambda
        gradients[inputs<=0] = Lambda * Sigma * np.exp(inputs[inputs<0])
        return gradients * grads_wrt_outputs
